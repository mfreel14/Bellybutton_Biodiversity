  ...
  d3.json("samples.json").then((data) => {
    ...
    var barLayout = {
      ...
      annotations: [{
        ...
        yanchor: 'center',
        showarrow: false,
        text: 'The bar chart shows the top 10 bacterial species (OTUs)<br>with the number of samples found in your belly button'
      }]
    };
...
var bubbleData = [{
  ...
  var gaugeLayout = { 
      ...
      annotations: [{
        ...
        y: 0,
        yanchor: 'center',
        text: "The above gauge displays weekly belly button washing frequency",
        showarrow: false
      }]
    };
